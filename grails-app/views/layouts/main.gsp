...
<head>
    ...
    <title>
        <g:layoutTitle default="Big-Tunes" />
    </title>
...
<div id="loginBox" class="loginBox">
    <g:if test="${session?.user}">
        <div style="margin-top:20px">
            ...
            <br>
            <br> You have purchased (${session.user.purchasedSongs?.size() ?: 0}) songs.
            <br>
        </div>
    </g:if>
    <g:else>
        <g:form name="loginForm" url="[controller:'user',action:'login']">
            ...
            <input type="image" src="${createLinkTo(dir:'images', file:'login.png')}" name="loginButton" id="loginButton" border="0"></input>
        </g:form>
...
<div id="navPane">
      ...
      <g:else>
        <div id="registerPane"> Need an account? <g:link controller="user" action="register">Signup now</g:link> to start your own personal Music collection!
        </div>
      </g:else>
</div>
